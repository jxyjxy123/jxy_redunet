...
def load_architecture(data, arch, seed=0):
    if data == 'mnist2d':
        ...
        if arch == 'lift2d_channels35_layers30':
            from architectures.mnist.lift2d import lift2d
            return lift2d(channels=35, layers=30, num_classes=10, seed=seed)
...
def load_dataset(choice, data_dir='./data/'):
    ...
    if choice == 'mnist2d_5class':
        from datasets.mnist import mnist2d_5class
        return mnist2d_5class(data_dir)
