...
parser.add_argument('--data', type=str, default='mnist2d_5class', help='choice of dataset')
parser.add_argument('--arch', type=str, default='lift2d_channels35_layers20', help='choice of architecture')
parser.add_argument('--samples', type=int, default=10, help="number of samples per update")
